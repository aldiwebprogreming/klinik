              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form method="post" action="<?= base_url('utama/add_status') ?>">
                    ...
                    <div class="modal-footer">
                      ...
                      <input type="submit" name="kirim" class="btn btn-primary" value="Tambah Status">
                    </form>
                  </div>
                </div>
              </div>
              ...
              <tbody>
                ...
                <?php foreach($status as $data){ ?>
                  <tr>
                   ...
                   <td>
                    <a href="<?= base_url('utama/hapus_status?id=') ?><?= $data['id'] ?>" class="btn btn-danger">Hapus</a>
                    ...
                    <div class="modal fade" id="exampleModal<?= $data['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form method="post" action="<?= base_url('utama/edit_status') ?>">
                              <div class="form-group">
                            ...
                            <div class="modal-footer">
                              ...
                              <input type="submit" name="kirim" class="btn btn-primary" value="Edit Status">
                            </form>
                          </div>
                        </div>
                      </div>
